...
namespace RetinaNetworking
{
    public class JSONHandler
    {
        ...
        public static DataSO DecodeStringSO(string encodedData)
        {
            DataSO result = ScriptableObject.CreateInstance<DataSO>();
        ...
        public static string EncodeString(DataSO dataToEncode)
        {
            string result;
        ...
        public static string EncodeString(NestedDataSO dataToEncode)
        {
            string result;
