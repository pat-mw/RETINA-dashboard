...
{
    public class ClientDetailsUI : MonoBehaviour
    {
        public static ClientDetailsUI Instance;

        public GameObject ClientDetailsPanelPrefab;

        private List<PlayerPanel> connectedPlayers = new List<PlayerPanel>();
        ...
        public void AddClientPanel(Client client)
        {
            ...
            foreach (PlayerPanel player in connectedPlayers)
            {
            ...
            try
            {
                ...
                PlayerPanel player = panel.GetComponent<PlayerPanel>();
